...
public class GeneratorCodeTests {
    ...
    public void generatorCode(){
        ...
        FastAutoGenerator
                // 1.配置数据源
                .create("jdbc:mysql://124.70.38.234:3306/enterprise_manage_system?useSSL=false&useUnicode=true&characterEncoding=UTF-8&allowMultiQueries=true","root","123456")
                // 2.全局配置
